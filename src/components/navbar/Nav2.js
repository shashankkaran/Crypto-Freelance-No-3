                    ...
                    <Toolbar >
                        ...
                        <Typography style={{ marginLeft: 'auto' }} variant="p" noWrap component="div">
                            ...
                            <ul className="navul">
                                ...
                                <li className='navli'> <button style={{ fontFamily: 'Noto Serif, cursive' }} class="a"><NavLink to='/'>Roadmap</NavLink></button></li>
                                <li className='navli'> <button style={{ fontFamily: 'Noto Serif, cursive' }} class="a"><NavLink to='/'>About Us</NavLink></button></li>
                                <li className='navli'> <button style={{ fontFamily: 'Noto Serif, cursive' }} class="a" ><NavLink to='/'>Features</NavLink></button></li>
                                <li className='navli'> <button style={{ fontFamily: 'Noto Serif, cursive' }} class="a"><NavLink to='/'>Home</NavLink></button></li>
                            </ul>
                        </Typography>
                    </Toolbar>
                </AppBar>
          ...
          {['Inbox', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem button key={text}>
              ...
              <ListItemText primary={text} />
                    ...
                    <List>
                        <NavLink onClick={handleDrawerClose} to="/">
                            <ListItem button>
                                <ListItemIcon>
                                    <HomeIcon />
                                </ListItemIcon>
                    ...
                    <Divider />
                    <List >
                        <NavLink smooth={true} duration={1000} onClick={handleDrawerClose} to="about">
                            <ListItem button>
                                <ListItemIcon>
                                    <CallIcon />
                                </ListItemIcon>
